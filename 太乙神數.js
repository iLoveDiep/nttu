...
for(var counter8 = 0; counter8 < 16; ++counter8)
{
	...
	map[counter8].checkMainGeneral();
	map[counter8].checkChiefOfficer();
	map[counter8].checkGeneralKe();
	map[counter8].checkGuestParticipant();
	map[counter8].checkDingGeneral();
	map[counter8].checkDifiniteGeneral();
}
